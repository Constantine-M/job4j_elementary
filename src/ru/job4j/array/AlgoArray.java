...
public class AlgoArray {
    public static void main(String[] args) {
        ...
        int temp = array[0]; /*переменная для временного хранения ячейки с индексом 0*/
        ...
        temp = array[1]; /*записываем для времен хранения значение ячейки с индексом 1*/
        ...
        temp = array[3]; /*записываем для времен хранения значение ячейки с индексом 3*/
        array[3] = array[4]; /*записываем в ячейку с индексом 3 значение ячейки с индексом 4*/
        array[4] = temp; /*записываем в ячейку с индексом 4 начение ячейки с временной переменной*/
